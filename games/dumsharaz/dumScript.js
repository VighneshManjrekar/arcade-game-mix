window.addEventListener("DOMContentLoaded", () => {
    ...
    function start() {
        ...
        document.getElementById('puzzle-img').src = `https://res.cloudinary.com/vighnesh/image/upload/v1618225521/dumsharaz/move/${ranNum}-min.jpg`
    ...
    document.querySelector(".ready").addEventListener("click",start)
